...
def register_map_callbacks(app):
    ...
    def earthquake_figure(colour, time, magnitude, depth):
        ...
        #filter earthquakes in selected time window that fit magnitude and depth threshold
        ...
        fig = px.scatter_map(
            ...
            color= "magnitude",
            hover_name = "place",
            hover_data = ["time", "magnitude", "depth", "longitude", "latitude"],
