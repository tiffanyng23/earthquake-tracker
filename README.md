...
This is a near live earthquake tracker made using Plotly Dash and the <a href="https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php", target="_blank">United States Geological Survey (USGS) earthquake API</a>.
